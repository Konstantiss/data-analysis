...
%% Execute this section to gather data
clc
clear
...
%Based on the (correlation in 2021) + (correlation in 2020) / 2, as shown
%above
mostStronglyCorrelatedCountryIds = [4 5];

weeklyPositivityRatesGreeceCroatia2021 = [weeklyPositivityRatesCountry2021(mostStronglyCorrelatedCountryIds(1),:)' weeklyPositivityRatesGreece2021'];
weeklyPositivityRatesGreeceCroatia2020 = [weeklyPositivityRatesCountry2021(mostStronglyCorrelatedCountryIds(1),:)' weeklyPositivityRatesGreece2020'];

weeklyPositivityRatesGreeceCyprus2021 = [weeklyPositivityRatesCountry2021(mostStronglyCorrelatedCountryIds(2),:)' weeklyPositivityRatesGreece2021'];
weeklyPositivityRatesGreeceCyprus2020 = [weeklyPositivityRatesCountry2020(mostStronglyCorrelatedCountryIds(2),:)' weeklyPositivityRatesGreece2020'];

weeklyPositivityRatesGreeceCroatia2021Boot = bootstrp(1000,@mean,weeklyPositivityRatesGreeceCroatia2021);
weeklyPositivityRatesGreeceCyprus2021Boot = bootstrp(1000,@mean,weeklyPositivityRatesGreeceCyprus2021);
weeklyPositivityRatesGreeceCroatia2020Boot = bootstrp(1000,@mean,weeklyPositivityRatesGreeceCroatia2020);
weeklyPositivityRatesGreeceCyprus2020Boot = bootstrp(1000,@mean,weeklyPositivityRatesGreeceCyprus2020);

corrcoef(weeklyPositivityRatesGreeceCroatia2021Boot)
corrcoef(weeklyPositivityRatesGreeceCyprus2021Boot)
corrcoef(weeklyPositivityRatesGreeceCroatia2020Boot)
corrcoef(weeklyPositivityRatesGreeceCyprus2020Boot)
